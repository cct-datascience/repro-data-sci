...
2.  [macOS git installation](https://sourceforge.net/projects/git-osx-installer/files/) <!--# Did anyone actually have to install git on macOS -->
...
-   Can also use example diagram for file system using instructor's ![](figures/file-structure-example.png)
