...
- RStudio Wizard _when creating an R project_
- `git init` in an _existing directory/R Project_
- `usethis::use_git` in an _existing R Project_
...
![](/lessons/3-git/new_proj_with_git.png)
...
![](/lessons/3-git/new_proj_no_git.png)
...
![](/lessons/3-git/new_proj_git_init.png)
...
![](/lessons/3-git/new_proj_usegit.png)
