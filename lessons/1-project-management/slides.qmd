...
-   GenAI/LLMs have been described as "hallucinating", "stochastic parrots"[^1], and even "bullshit machines"
    [^2]
...
-   AI presents a host of ethical[^4], environmental[^5], and legal issues (e.g. plagiarism) to conside
    r
