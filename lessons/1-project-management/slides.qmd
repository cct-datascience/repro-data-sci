...
## RStudio projects <!--# Should we wait on this? -->
...
## Settings for Success <!--# Should we wait on this? -->
...
A README is a plain text (often .md[^1] or .txt) document in your research compendium that describes:
...
-   What it contains (descriptions of folders & files)

-   How people are allowed to use your code and data

-   How to reproduce the analysis or contribute to it
:::
...
-   GenAI/LLMs have been described as "hallucinating", "stochastic parrots"[^2], and even "bullshit machines"
    [^3]
...
-   Beginners have difficulty spotting mistakes in AI generated code solutions[^4]
...
-   AI presents a host of ethical[^5], environmental[^6], and legal issues to conside
    r
...
[^1]: We will talk more about .md files (markdown) on Thursday

[^2]: <https://en.wikipedia.org/wiki/Stochastic_parrot>

[^3]: @hicks2024

[^4]: <https://www.theregister.com/2023/08/07/chatgpt_stack_overflow_ai/>

[^5]: <https://mashable.com/article/chat-gpt-open-ai-workers-exploitation>

[^6]: <https://www.technologyreview.com/2023/12/05/1084417/ais-carbon-footprint-is-bigger-than-you-think/>
